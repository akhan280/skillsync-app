...
const SkillSyncLogo = React.forwardRef<HTMLDivElement, SkillSyncLogoProps>(
  ({ size, className, ...props }, ref) => {
    ...
    return (
      <div className={cn(logoVariants({ size }), className)} ref={ref} {...props}>
        <svg xmlns="http://www.w3.org/2000/svg" width={chosenSize.width} height={chosenSize.height} viewBox="0 0 89 89" fill="none">
